...
(function ($) {
    ...
    $.fn.aksVideoPlayer = function (options) {
      ...
      return this.each(function (i) {
        ...
        html +=
          '<video id="aks-video" class="aks-video vjs-theme-fantasy" tabindex="-1" disableremoteplayback="" webkit-playsinline="" playsinline="" preload="metadata" src="' +
          video +
          '" style="height:100%;width:100%;" muted autoplay></video>';
        ...
        html +=
          ...
          video +
          '" muted autoplay hidden></video></div>';
        $(aks).append(html);
